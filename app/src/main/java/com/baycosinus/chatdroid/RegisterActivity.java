...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Pack p = new Pack("check_available", new User(0,username,null,null), new User(0,null,null,null), null);
    ...
    class Send extends AsyncTask<JSONObject, Void, Boolean>
    {
        ...
        protected void onPostExecute(Boolean aBoolean)
        {
            if(aBoolean)
            {
                new RegisterActivity.Listen(PORT).execute();
            }
        }
    }
    ...
    class Listen extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPostExecute(String s)
        {
            ...
            if(result)
            {
                Pack p = new Pack("register", new User(0,username, password, null), new User(0,null,null,null),null);
                JSONObject pack = p.Pack2JSON();
                new Send(HOST,PORT).execute(pack);
